...
AWS provides 100+ services but i learn which can be the best for DevOps daily workflows.

## First Service of AWS- EC2.

Starting with EC2- Elastic Cloud Compute. This service is used to create virtual machines or server called as Instance.
